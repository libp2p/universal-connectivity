...
export async function startLibp2p(options: {} = {}) {
  ...
  const libp2p = await createLibp2p({
    ...
    peerDiscovery: [
      bootstrap({
        list: [
         '/ip4/192.168.1.5/udp/9090/webrtc-direct/certhash/uEiBy_U1UNQ0IDvot_PKlQM_QeU3yx-zCAVaMxxVm2JxWBg/p2p/12D3KooWGTDZj1zAjMCJ8XXx9Z88zAAd6vn3krQYLwZ67S4vMUxz',
        ],
      }),
    ],
    pubsub: gossipsub({
